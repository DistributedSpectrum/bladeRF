...
struct printset_entry printset_table[] = {
    ...
    PRINTSET_ENTRY(table_gain,   PRINTALL_OPTION_APPEND_NEWLINE, BOARD_BLADERF2),
    ...
    PRINTSET_ENTRY(time_marker,  PRINTALL_OPTION_APPEND_NEWLINE, BOARD_BLADERF2),
